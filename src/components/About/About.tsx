          ...
          <div className="mb-5">
            ...
            <div className="md:flex ">
              <p className="md:w-[50%] sm:mb-10 md:mr-10">
                ...
                computer science course in C++, sparking my interest in coding.
                Though I was initially focused on becoming a psychologist, the
                creativity and logic of programming captivated me.
              </p>
          ...
          <div className="mb-5">
            ...
            <div className="md:flex ">
              <p className="md:w-[50%] sm:mb-10 md:mr-10">
                ...
                changed in the summer of 2024 when I decided to focus on
                programming full-time. I immersed myself in web development,
                learning through freeCodeCamp, The Odin Project, documentation,
                and YouTube tutorials. That summer, I realized software
                engineering was my true passion.
              </p>
              <div className="w-[80%] md:w-[50%] lg:w-[40%] flex flex-col items-center bg-darker rounded-lg">
                <Image
                  src={SanFrancisco}
          ...
          <div className="mb-5">
            ...
            <div className="md:flex ">
              <p className="md:w-[50%] sm:mb-10 md:mr-10">
                ...
                collaborative engineering team, and build scalable applications
